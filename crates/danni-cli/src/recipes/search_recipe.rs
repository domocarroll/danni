...
use super::github_recipe::{
    ...
    DANNI_RECIPE_GITHUB_REPO_CONFIG_KEY,
};
use danni::recipe::local_recipes::{list_local_recipes, load_local_recipe_file};
...
fn configured_github_recipe_repo() -> Option<String> {
    ...
    match config.get_param(DANNI_RECIPE_GITHUB_REPO_CONFIG_KEY) {
