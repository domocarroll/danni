...
use danni::conversation::message::{Message, MessageContent, TokenState};
use danni::conversation::Conversation;
use danni::permission::{Permission, PermissionConfirmation};
    ...
    match content {
        MessageContent::ToolRequest(tool_request) => {
            if let Ok(tool_call) = &tool_request.tool_call {
                tracing::info!(monotonic_counter.danni.tool_calls = 1,
