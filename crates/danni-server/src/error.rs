...
mod tests {
    ...
    fn test_env_var_conversion() {
        assert_eq!(to_env_var("type"), "DANNI_PROVIDER__TYPE");
        assert_eq!(to_env_var("api_key"), "DANNI_PROVIDER__API_KEY");
        assert_eq!(to_env_var("provider.host"), "DANNI_PROVIDER__HOST");
        assert_eq!(to_env_var("provider.api_key"), "DANNI_PROVIDER__API_KEY");
    }
}
