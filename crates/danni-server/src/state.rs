...
use danni::execution::manager::AgentManager;
...
impl AppState {
    ...
    pub async fn get_agent(&self, session_id: String) -> anyhow::Result<Arc<danni::agents::Agent>> {
    ...
    pub async fn get_agent_for_route(
        &self,
        session_id: String,
    ) -> Result<Arc<danni::agents::Agent>, StatusCode> {
