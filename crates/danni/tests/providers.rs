...
use danni::providers::anthropic::ANTHROPIC_DEFAULT_MODEL;
use danni::providers::azure::AZURE_DEFAULT_MODEL;
use danni::providers::base::Provider;
use danni::providers::bedrock::BEDROCK_DEFAULT_MODEL;
...
use danni::providers::google::GOOGLE_DEFAULT_MODEL;
use danni::providers::litellm::LITELLM_DEFAULT_MODEL;
use danni::providers::ollama::OLLAMA_DEFAULT_MODEL;
use danni::providers::openai::OPEN_AI_DEFAULT_MODEL;
use danni::providers::sagemaker_tgi::SAGEMAKER_TGI_DEFAULT_MODEL;
use danni::providers::snowflake::SNOWFLAKE_DEFAULT_MODEL;
use danni::providers::xai::XAI_DEFAULT_MODEL;
...
impl ProviderTester {
    ...
    async fn test_image_content_support(&self) -> Result<()> {
        ...
        let image_path = "crates/danni/examples/test_assets/test_image.png";
