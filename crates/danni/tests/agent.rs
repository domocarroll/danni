...
use danni::config::extensions::{set_extension, ExtensionEntry};
...
mod tests {
    ...
    mod schedule_tool_tests {
        ...
        use danni::agents::platform_tools::PLATFORM_MANAGE_SCHEDULE_TOOL_NAME;
        use danni::scheduler::{ScheduledJob, SchedulerError};
        use danni::scheduler_trait::SchedulerTrait;
        use danni::session::Session;
        use std::sync::Arc;
    ...
    mod retry_tests {
        use super::*;
        use danni::agents::types::{RetryConfig, SuccessCheck};

        #[tokio::test]
        async fn test_retry_success_check_execution() -> Result<()> {
            use danni::agents::retry::execute_success_checks;
    ...
    mod max_turns_tests {
        ...
        use danni::providers::base::{Provider, ProviderMetadata, ProviderUsage, Usage};
    ...
    mod extension_manager_tests {
        use super::*;
        use danni::agents::extension::{ExtensionConfig, PlatformExtensionContext};
        use danni::agents::extension_manager_extension::{
        ...
        async fn setup_agent_with_extension_manager() -> Agent {
            ...
            let todo_extension_entry = ExtensionEntry {
                ...
                config: ExtensionConfig::Platform {
                    name: "todo".to_string(),
                    description:
                        "Enable a todo list for Danni so it can keep track of what it is doing"
                            .to_string(),
                    bundled: Some(true),
                    available_tools: vec![],
                },
