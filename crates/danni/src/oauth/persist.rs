...
/// Danni-specific credential store that uses the Config system
///
/// This implementation stores OAuth credentials in the danni configuration
/// system, which handles secure storage (e.g., keychain integration).

#[derive(Clone)]
pub struct DanniCredentialStore {
    name: String,
}

impl DanniCredentialStore {
...
impl CredentialStore for DanniCredentialStore {
