...
use crate::oauth::persist::DanniCredentialStore;
...
pub async fn oauth_flow(
    ...
    let credential_store = DanniCredentialStore::new(name.clone());
    ...
    oauth_state
        .start_authorization(&[], redirect_uri.as_str(), Some("danni"))
        .await?;
