...
impl ClientHandler for DanniClient {
    ...
    async fn create_message(
        ...
        let system_prompt = params
            .system_prompt
            .as_deref()
            .unwrap_or("You are a general-purpose AI agent called danni");
        ...
        Ok(CreateMessageResult {
            ...
            message: SamplingMessage {
                ...
                // This doesn't mesh well with danni's approach which has Vec<MessageContent>
                ...
                content: if let Some(content) = response.content.first() {
                    match content {
                        ...
                        // TODO(alexhancock) - Content::Audio? danni's messages don't currently have it
                        _ => Content::text(""),
                    }
                } else {
                    Content::text("")
    ...
    fn get_info(&self) -> ClientInfo {
        ClientInfo {
            ...
            client_info: Implementation {
                name: "danni".to_string(),
                version: std::env::var("DANNI_MCP_CLIENT_VERSION")
...
pub struct McpClient {
    client: Mutex<RunningService<RoleClient, DanniClient>>,
...
impl McpClient {
        ...
        E: std::error::Error + From<std::io::Error> + Send + Sync + 'static,
    {
        ...
        let client = DanniClient::new(notification_subscribers.clone(), provider);
        let client: rmcp::service::RunningService<rmcp::RoleClient, DanniClient> =
