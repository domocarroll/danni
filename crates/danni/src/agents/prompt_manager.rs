...
use crate::hints::load_hints::{load_hint_files, AGENTS_MD_FILENAME, DANNI_HINTS_FILENAME};
use crate::{
    config::{Config, DanniMode},
    prompt_template,
...
impl<'a> SystemPromptBuilder<'a, PromptManager> {
    ...
    pub fn build(self) -> String {
        ...
        let context = SystemPromptContext {
            ...
            danni_mode,
            is_autonomous: danni_mode == DanniMode::Auto,
        ...
        .unwrap_or_else(|_| {
            "You are a general-purpose AI agent called danni, created by Subfracture".to_string()
        });
