...
use crate::config::{get_enabled_extensions, Config, DanniMode};
...
const COMPACTION_THINKING_TEXT: &str = "danni is compacting the conversation...";
...
impl Agent {
    ...
    async fn prepare_reply_context(
        ...
        self.tool_inspection_manager
            .update_permission_inspector_mode(danni_mode)
            .await;
            ...
            let final_conversation = if !needs_auto_compact && !is_manual_compact {
                ...
                if !is_manual_compact {
                    ...
                    let threshold = config
                        .get_param::<f64>("DANNI_AUTO_COMPACT_THRESHOLD")
    ...
    pub async fn create_recipe(&self, mut messages: Conversation) -> Result<Recipe> {
        ...
        let settings = Settings {
            danni_provider: Some(provider_name.clone()),
            danni_model: Some(model_name.clone()),
