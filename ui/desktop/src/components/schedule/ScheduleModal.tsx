      ...
      try {
        ...
        if (recipe) {
          ...
          setInternalValidationError(
            'Invalid deep link format. Please use a danni://bot or danni://recipe link.'
          );
        }
      } catch {
        setParsedRecipe(null);
        setInternalValidationError(
          'Failed to parse deep link. Please ensure using a danni://bot or danni://recipe link and try again.'
        );
      }
    } else {
      setParsedRecipe(null);
                  ...
                  {sourceType === 'deeplink' && (
                    <div>
                      <Input
                        ...
                        placeholder="Paste danni://bot or danni://recipe link here..."
